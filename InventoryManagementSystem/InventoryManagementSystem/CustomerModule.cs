    ...
    public partial class CustomerModule : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Are tou sure you want to save this customer", "Saving Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
               if(MessageBox.Show("Are tou sure you want to update this customer", "Update Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                  {
